      ...
      home: Scaffold(
        ...
        body: Column(
          children: [
            ...
            Expanded(flex: 1, child: ErrorWidget(lastError: lastError)),
...
class RecognitionResultsWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        const Center(
          child: Text('Recognized Words', style: TextStyle(fontSize: 22.0)),
        ),
        Expanded(
          child: Stack(
            children: <Widget>[
...
class ErrorWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        const Center(
          child: Text('Error Status', style: TextStyle(fontSize: 22.0)),
        ),
        ...
        children: <Widget>[
          ...
          Row(
            children: [
              ...
              Checkbox(value: logEvents, onChanged: switchLogging),
            ],
          ),
        ],
      ),
